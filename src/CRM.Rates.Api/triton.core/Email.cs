...
namespace Triton.Core
{
    public class Email
    {
        ...
        public static Task SendIntraSystemEmail(string[] to, string[] cc, string from, string body, string subject, string smtpServer, List<Attachment> attachments)
        {
            return SendIntraSystemEmail(to, cc, from, body, subject, smtpServer, attachments, null);
        }
        ...
        public static Task SendIntraSystemEmail(string[] to, string[] cc, string from, string body, string subject, string smtpServer, List<Attachment> attachments, string system)
        {
            try
            {
                // create mail message object
