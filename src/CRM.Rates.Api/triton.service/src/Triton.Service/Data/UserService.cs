...
namespace Triton.Service.Data
{
    public static class UserService
    {
        ...
        //public static async Task<List<UserDetails>> GetUserDetails(int userid)
        //{
        //    return await _connection.GetAsync<List<Triton.Model.TritonGroup.StoredProcs.UserDetails>>("TritonGroupStoredProcs","GetUserDetails",$"UserID={userid}", StringHelpers.Globals.OldApiDeprecated);
        //}
    }
}
